...
const footer = () => {
  ...
  <div className='whole-footer'>
    <div className='footer'>
      ...
      <p ><a className='footer-link' href='https://www.instagram.com/mattesowah/' target='_blank' >INSTAGRAM</a></p>
      ...
      <p ><a className='footer-link' href='https://www.linkedin.com/in/alan-m-sowah-quarshie-4bb3a8207/' target='_blank' >LINKEDIN</a></p>
